...
public class ParameterMonitor {
    ...
    public static final int PARAM_EVENT_COMM = 20;
    public static final int PDA_ERROR_RECOVER = 21;
    public static final int PARAM_HISTORY_LAST = 22;
    ...
    public static final int PARAM_NEW = 9;
